                        ...
                        <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                            ...
                            <tbody>
                                @foreach ($competitions as $competition)
                                    <tr
                                        x-data = "{isLastItem : {{ $competition == end($competitions) ? 'true' : 'false' }}}">
                                        <td class="p-2 align-middle
                                        bg-transparent whitespace-nowrap shadow-transparent"
                                            x-bind:class="isLastItem ? 'border-b-0' : 'border-b'">
                                            <span
                                                class="bg-gradient-to-tl from-green-600 to-lime-400 px-2.5 text-xs rounded-1.8 py-1.4 whitespace-nowrap text-center align-baseline font-bold uppercase leading-none text-white">{{ $competition['league_name'] }}</span>
                                        </td>
                                        </td>
                                        <td class="p-2 align-middle bg-transparent whitespace-nowrap shadow-transparent"
                                            x-bind:class="isLastItem ? 'border-b-0' : 'border-b'">
                                            <div>
                                                <img src="{{ $competition['league_logo'] }}"
                                        ...
                                        <td class="p-2 align-middle bg-transparent whitespace-nowrap shadow-transparent"
                                            ...
                                            <p class="mb-0 text-xs leading-tight text-slate-400">
                                                {{ $competition['country_name'] }}</p>
                                        </td>
                                        <td class="p-2 align-middle bg-transparent whitespace-nowrap shadow-transparent"
                                            x-bind:class="isLastItem ? 'border-b-0' : 'border-b'">
                                            <p class="mb-0 text-xs leading-tight text-slate-400">
                                                {{ $competition['league_season'] }}</p>
                                        </td>
                                        <td class="p-2 text-sm leading-normal text-center align-middle bg-transparent whitespace-nowrap shadow-transparent"
                                            x-bind:class="isLastItem ? 'border-b-0' : 'border-b'">
                                            <span
                                                class="bg-gradient-to-tl from-green-600 to-lime-400 px-2.5 text-xs rounded-1.8 py-1.4 inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none text-white">{{ $competition['league_id'] }}</span>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
